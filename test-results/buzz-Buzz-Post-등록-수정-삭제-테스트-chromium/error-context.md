...
Locator: locator('.orangehrm-buzz').filter({ has: locator('.orangehrm-buzz-post-body-text').filter({ hasText: 'Post Test, Date : 2026-08-04 084828' }) }).locator('.orangehrm-post-comment')
Expected substring: "Edit Comment : 084828"
Received string:    "ahn  intaekComment Test : 084828Read More2026-08-04 08:48 AM1LikeEditDelete"
Timeout: 10000ms

Call log:
  - Expect "toContainText" with timeout 10000ms
  - waiting for locator('.orangehrm-buzz').filter({ has: locator('.orangehrm-buzz-post-body-text').filter({ hasText: 'Post Test, Date : 2026-08-04 084828' }) }).locator('.orangehrm-post-comment')
    24 × locator resolved to <div data-v-2d912105="" class="orangehrm-post-comment">…</div>
       - unexpected value "ahn  intaekComment Test : 084828Read More2026-08-04 08:48 AM1LikeEditDelete"

```

```yaml
- paragraph: ahn intaek
- text: "Comment Test : 084828"
- paragraph: 2026-08-04 08:48 AM
- text: 
- paragraph: "1"
- paragraph: Like
- paragraph: Edit
